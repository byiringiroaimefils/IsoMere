  ...
  return (
    <>
      ...
      <div className="container mt-20 mx-auto px-4 max-w-4xl">
        <h1 className="text-4xl font-bold text-center mb-8 text-indigo-700">Privacy Policy</h1>
        <p className="text-lg mb-8 text-gray-700">At StoryVerse, we are committed to protecting your privacy and ensuring the security of your personal information. This Privacy Policy explains how we collect, use, and safeguard your data when you use our website and services.</p>
        
        <h2 className="text-3xl font-semibold mb-4 text-indigo-600 border-b-2 border-indigo-200 pb-2">Information We Collect</h2>
        ...
        <h2 className="text-3xl font-semibold mb-4 text-indigo-600 border-b-2 border-indigo-200 pb-2">How We Use Your Information</h2>
        ...
        <h2 className="text-3xl font-semibold mb-4 text-indigo-600 border-b-2 border-indigo-200 pb-2">Data Security</h2>
        ...
        <h2 className="text-3xl font-semibold mb-4 text-indigo-600 border-b-2 border-indigo-200 pb-2">Sharing Your Information</h2>
        ...
        <h2 className="text-3xl font-semibold mb-4 text-indigo-600 border-b-2 border-indigo-200 pb-2">Your Rights</h2>
        ...
        <h2 className="text-3xl font-semibold mb-4 text-indigo-600 border-b-2 border-indigo-200 pb-2">Changes to This Policy</h2>
        ...
        <h2 className="text-3xl font-semibold mb-4 text-indigo-600 border-b-2 border-indigo-200 pb-2">Contact Us</h2>
        <p className="mb-6 text-gray-700">If you have any questions or concerns about our Privacy Policy, please contact us at <a href="mailto:privacy@storyverse.com" className="text-indigo-600 hover:underline">privacy@storyverse.com</a>.</p>

        <p className="text-lg font-semibold text-center text-indigo-700">Last updated: August 16, 2024</p>
      </div> <br /><br />
      <Footer />
    </>
  );
